...
- Check if `/product/design-system/elements.json` exists
...
**If `/product/design-system/elements.json` exists:**
- Note the element choices for reference in comments
- The elements will be applied at the app level, but use appropriate element styles
